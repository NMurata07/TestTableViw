...
class cutomTableViewController: UITableViewController {
    ...
    let fruits = ["apple", "orange", "melon", "banana", "pineapple", "apple", "orange", "melon", "banana", "pineapple", "apple", "orange", "melon", "banana", "pineapple", "apple", "orange", "melon", "banana", "pineapple"]
